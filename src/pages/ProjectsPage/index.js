...
const ProjectsPage = () => {
  return (
    <>
      ...
      <ContainerTop>
        <BoxesWrapper>
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="Wa Montagem de Elevadores" right={false} left={false}>
            Landing page com formulário de contato desenvolvido para a empresa Wa Montagem de Elevadores.
          </BoxInfo>
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="Sistema completo de gestão de um restaurante, com controle de estoque" right={false} left={false}>
          ...
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="Web Chat em tempo real" right={false} left={false}>
          ...
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="App deste portifolio." right={false} left={false}>
          ...
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="App de geração e leitura de qrcodes" right={false} left={false}>
          ...
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="Jogo da memória com números - aplicação para desktop" right={false} left={false}>
          ...
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="App de gestão e controle de dados" right={false} left={false}>
          ...
          <BoxInfo style={{cursor: "pointer"}} hover={true} title="Sistema de recomendação de músicas" right={false} left={false}>
            Trabalho final de uma disciplina na faculdade: Métodos de Programação. O projeto foi feito com POO, programação orientada a testes, e foram utilizadas as metodologias ágeis Scrum e Kanban. A recomendação da música é feita com base no interesse de outros usuários que acessam o sistema.
          </BoxInfo>
          <BoxInfo style={{cursor: "pointer", height: "22rem"}} hover={true} title="*Extra: Sistema de gestão de turmas e alunos da universidade" right={false} left={false}>
