...
const ProjectsPage = () => {
  return (
    <>
      ...
      <ContainerTop>
        <BoxesWrapper>
          <BoxInfo links={["https://waelevadores.com.br/"]} linksDisplay={["block", "none", "none", "none", "none", "none"]} title="Wa Montagem de Elevadores" right={false} left={false}>
            Landing page com formulário de contato desenvolvido para a empresa Wa Montagem de Elevadores.
          </BoxInfo>
          <BoxInfo links={["https://waelevadores.com.br/"]} linksDisplay={["block", "none", "none", "none", "none", "none"]} title="Sistema completo de gestão de um restaurante, com controle de estoque" right={false} left={false}>
          ...
          <BoxInfo style={{}} title="Jogo da memória com números - aplicação para desktop" right={false} left={false}>
          ...
          <BoxInfo style={{}} title="App de gestão e controle de dados" right={false} left={false}>
          ...
          <BoxInfo style={{height: "22rem"}} title="*Extra: Sistema de gestão de turmas e alunos da universidade" right={false} left={false}>
